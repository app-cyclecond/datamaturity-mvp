  ...
  const plans = [
    {
      ...
      features: [
        ...
        { name: "Biblioteca Bronze (documentos nível Bronze)", included: true },
    ...
    },
    {
      ...
      features: [
        ...
        { name: "Benchmarking do seu setor", included: true },
        { name: "Biblioteca Bronze + Silver (documentos nível Bronze e Silver)", included: true },
    ...
    },
    {
      ...
      features: [
        ...
        { name: "Biblioteca Completa (Bronze + Silver + Gold)", included: true },
        { name: "Roadmap personalizado", included: true },
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {[
                  ...
                  { feature: "Biblioteca de conteúdo", bronze: "Docs Bronze", silver: "Docs Bronze + Silver", gold: "Docs Bronze + Silver + Gold" },
