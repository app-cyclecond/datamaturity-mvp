...
-- Update plan column to use new plan names
alter table public.users 
...
add constraint subscriptions_plan_check check (plan in ('bronze', 'silver', 'gold', 'starter'));
...
create policy "Users can view content based on their plan"
